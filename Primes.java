...
public class Primes {
	  ...
	  private static void findPrimesFaster(int nValues, boolean printPrimes) {
	    ...
	    System.out.println("The method findPrimesFaster has been implemented");
		    }
	  }
	  ...
	  private static void findPrimesEvenFaster(int nValues, boolean printPrimes) {
		    ...
		    for (int i = 2; i <= nValues; i++) {
		      ...
		      System.out.println("The method findPrimesEvenFaster has been implemented");
	  }
	  }
	  ...
	  public static void main(String[] args) {
	    ...
	    startTime = System.currentTimeMillis();
	    findPrimesEvenFaster(20000, false);
	    endTime = System.currentTimeMillis();
	    System.out.println("  " + (endTime - startTime) + " milliseconds");
	    ...
	    System.out.print("\nTiming method findPrimesEvenFaster:");
	    startTime = System.currentTimeMillis();
	    findPrimesEvenFaster(50000, false);
	    endTime = System.currentTimeMillis();
	    System.out.println("  " + (endTime - startTime) + " milliseconds");
	  }
