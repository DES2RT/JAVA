 ...
 * 023567902
 * 
 *	This LLMobileDevice.java file is the class template for a mobile device. The mobile device is the
...
public class LLMobileDevice implements Comparable<LLMobileDevice> {
     ...
     */
    public LLMobileDevice(String deviceName, int valueTag) throws DateFormatException {
...
//===============================================================================>
    ...
    public boolean rentDevice(String rentDate, String dueDate, LLLab lab) throws DateFormatException, RentPeriodException {
    ...
    public boolean isRented(LLLab lab) {
    ...
    public void returnDevice(LLLab lab) throws RentPeriodException, DateFormatException {
    	LLMobileDevice temp = this;
    	for(Iterator<LLMobileDevice> it = lab.devices.iterator(); it.hasNext(); ) {
    		LLMobileDevice next = it.next();
    ...
    public String availableDate(LLLab lab) {
    ...
    public boolean equals(Object o) {
        ...
        if( !(o instanceof LLMobileDevice)) return false;
        
        LLMobileDevice md = (LLMobileDevice)o;
    ...
    @Override
    public int compareTo(LLMobileDevice md) {
...
//====================================================================>>>>
    ...
    private class RentSettings {
        ...
        private RentSettings(String rentDate, String dueDate, LLLab lab) 
        ...
        public int hashCode() {
        	...
        	int val = 88 * val + this.rentDate.hashCode();
        	val += val;
        	return val;
        }
        @Override 
